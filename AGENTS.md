...
- Cobrança Premium (proposta, Asaas Checkout com cartão, anual −20%, cancelar recorrência sem estorno): `docs/billing.md` e `docs/decisions/ADR-004-asaas-checkout.md`. O plano ainda só muda pelo admin.
