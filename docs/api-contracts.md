...
- `GET /fishing-spots/{id}/forecast`: dias de previsão do local visível e incluído nas regiões preferidas, inclusive local pessoal do dono. O item de ranking também inclui `isOwner`.
