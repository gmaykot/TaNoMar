...
Cobrança do Premium (proposta): Checkout hospedado do Asaas, só cartão, assinatura anual com 20% de desconto sobre 12 meses. Cancelar a recorrência não estorna; o acesso segue até o fim do período pago. Ver [billing.md](billing.md) e [ADR-004](decisions/ADR-004-asaas-checkout.md).
