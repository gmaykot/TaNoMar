...
- Na home, data e previsão ficam no mesmo carrossel: um gesto troca o dia inteiro, sem recalcular a nota no cliente. O título acompanha o dia escolhido. A nota visível é a média das 3 melhores horas; as métricas da melhor hora ficam em “Ver condições”. Clicar em **Notas dos melhores horários** mostra as condições daquela janela; a nota do dia não muda.
