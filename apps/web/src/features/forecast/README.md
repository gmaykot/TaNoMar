...
- Na home, data e previsão ficam no mesmo carrossel: um gesto troca o dia inteiro, sem recalcular a nota no cliente. O título acompanha o dia escolhido. O dia ativo vai em `?data=` e o ranking reabre nesse dia.
