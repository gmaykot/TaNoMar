  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        lang: 'pt-BR',
        icons: [
          { src: '/brand/pwa/icon-192.png?v=2', sizes: '192x192', type: 'image/png', purpose: 'any' },
          { src: '/brand/pwa/icon-512.png?v=2', sizes: '512x512', type: 'image/png', purpose: 'any' },
          {
            src: '/brand/pwa/icon-1024.png?v=2',
            sizes: '1024x1024',
            type: 'image/png',
            purpose: 'any',
          },
          {
            src: '/brand/pwa/icon-maskable-192.png?v=2',
            sizes: '192x192',
            type: 'image/png',
            purpose: 'maskable',
          },
          {
            src: '/brand/pwa/icon-maskable-512.png?v=2',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'maskable',
          },
          {
            src: '/brand/pwa/icon-maskable-1024.png?v=2',
            sizes: '1024x1024',
            type: 'image/png',
            purpose: 'maskable',
          },
